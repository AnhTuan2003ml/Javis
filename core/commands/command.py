...
class EmotionSystem:
    def __init__(self):
        ...
        self.emotion_file = 'config/emotion_config.json'
...
class TaskScheduler:
    def __init__(self):
        ...
        self.running = False
        self.tasks_file = 'data/state/scheduled_tasks.json'
        self.load_tasks()
...
def allCommands(message=1):
    ...
    if "aura" in query.lower():
        try:
            from core.ai.ultimate_ai_executor import ultimate_ai
...
def save_ui_setting(key, value):
    """Save setting to config/ui_config.json"""
    try:
        import json
...
def load_ui_settings():
    """Load settings from config/ui_config.json"""
    ...
    try:
        ...
        if ("send message to" in query and (" on whatsapp " in query or " on mobile " in query)) or \
           ("whatsapp message to" in query) or ("sms to" in query):
            ...
            try:
                import re
                from core.commands.features import findContact, whatsApp, sendMessage
        ...
        # Contact-based calling and messaging (existing method)
            ...
            from core.commands.features import findContact, whatsApp, makeCall, sendMessage
        ...
        # SMS Test Commands
            ...
            from core.commands.features import testSMS
            testSMS()
            eel.ShowHood()
            return
        ...
        # Phone Commands (must have "on phone" suffix)
            ...
            from core.phone.phone import handle_phone_commands
        ...
        # Add contact command
            ...
            try:
                ...
                if match:
                    ...
                    # Add to database
                    con = sqlite3.connect("data/databases/jarvis.db")
                    cursor = con.cursor()
