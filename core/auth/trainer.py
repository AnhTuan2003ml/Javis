...
def train_face_model():
    ...
    if not os.path.exists(path):
        ...
        print("Please run 'py core/auth/sample.py' first to capture face samples.")
        return False
    ...
    try:
        ...
        os.makedirs('core\\auth\\trainer', exist_ok=True)
        
        # Save the trained model
        recognizer.write('core\\auth\\trainer\\trainer.yml')
