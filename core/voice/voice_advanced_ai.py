...
class VoiceAdvancedAI:
    def __init__(self):
        ...
        self.MEMORY_DB = os.path.join(project_dir, "data", "databases", "jarvis_memory.db")
        self.CALENDAR_JSON = os.path.join(project_dir, "data", "state", "jarvis_calendar.json")
        self.VAULT_DIR = os.path.join(project_dir, "data", "vault")
        self.USAGE_LOG = os.path.join(project_dir, "data", "state", "jarvis_usage.json")
        self._ensure_db()
