...
- "disable next move predictions" → METHOD: system, COMMAND: from core.ai.ultimate_ai_executor import ultimate_ai; print(ultimate_ai.disable_next_move_predictions())
- "enable next move predictions" → METHOD: system, COMMAND: from core.ai.ultimate_ai_executor import ultimate_ai; print(ultimate_ai.enable_next_move_predictions())
- "next move status" → METHOD: system, COMMAND: from core.ai.ultimate_ai_executor import ultimate_ai; print(f"Next move predictions: {'Enabled' if ultimate_ai.get_next_move_status() else 'Disabled'}")
