...
def readCalendarEvents():
    """Read calendar events from data/state/jarvis_calendar.json"""
    try:
        calendar_path = 'data/state/jarvis_calendar.json'
...
@eel.expose
def readReminders():
    """Read reminders from data/state/reminders.json"""
    try:
        reminders_path = 'data/state/reminders.json'
